        ...
        >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center justify-center gap-2 bg-white text-black px-6 py-2.5 rounded-full font-medium hover:bg-gray-100 transition-colors text-sm w-[200px] sm:w-auto"
            >
              Launch a store
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center justify-center gap-2 bg-transparent text-white px-6 py-2.5 rounded-full font-medium border-2 border-white hover:bg-white hover:text-black transition-colors text-sm w-[200px] sm:w-auto"
            >
              Contact sales
            </motion.a>
          </motion.div>
